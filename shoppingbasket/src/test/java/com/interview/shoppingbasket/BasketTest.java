...
public class BasketTest {
    ...
    void consolidateBasketTest() {
        ...
        basket.add("productCode", "myProduct", 5);
        basket.add("productCode2", "myProduct2", 10);
        basket.add("productCode3", "myProduct3", 3);
        ...
        assertEquals(basketItems.get(0).getQuantity(), 10);
        assertEquals(basketItems.get(1).getQuantity(), 10); 
        assertEquals(basketItems.get(2).getQuantity(), 10); 
    }
}
